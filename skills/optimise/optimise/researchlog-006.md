<!-- SUMMARY-START -->
## Run 006 — 2026-03-22 | Target: skills/optimise
Composite: 93.1% → 98.1% (+5.0 pp)

### Hypotheses
| ID  | Description                                                          | Outcome   |
|-----|----------------------------------------------------------------------|-----------|
| H25 | Promote NP4/NP5/NP6 as P12/P13/P14                                   | Confirmed |
| H26 | Add research-log archival guidance to Phase 5                         | Confirmed |
| H27 | Targeted redundancy audit (Redundancy Index investigation)            | Confirmed |
| H28 | Enrich H22 result record with explicit causal mechanism               | Confirmed |
...
**Token estimate:** ~10,256 instruction-file tokens (+344t from v1.7.0 additions); help.md ~10,122t; support/log tokens not scored
...
**Direction:** ↑ higher is better (small, well-structured, archivable log = 100)
**Weight:** 1×
...
Custom re-applied: MX1–MX19 (all prior custom metrics)
Custom new: MX20 NPPC, MX21 RLSM, MX22 HET, MX23 CMSR, MX24 ICC
...
**Pattern applied:** novel — Content Synchronisation Audit (NP4: when instruction files are updated with new named entries, update the corresponding reference file in the same session)
**Risk level:** low
