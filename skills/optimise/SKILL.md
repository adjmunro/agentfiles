...
process, and design patterns (P1–P11): see `commands/phases/p2-baseline.md` (metrics)
...
as seed candidates they are promoted to P10+ in `commands/phases/p3-hypothesize.md`.
